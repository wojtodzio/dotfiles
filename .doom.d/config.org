...
#+END_SRC
* Projectile
Disable cache so new files are immediately visible
#+BEGIN_SRC emacs-lisp
...
(use-package aidermacs
  ...
  (setq aidermacs-architect-model "openrouter/openai/o3-high")
  (setq aidermacs-editor-model "openai/o1-mini")
  (setq aidermacs-backend 'vterm)
  ;; (setenv "ANTHROPIC_API_KEY" anthropic-api-key)
  ;; (global-set-key (kbd "C-c a") 'aidermacs-transient-menu)
  (setq aidermacs-use-architect-mode t))
#+END_SRC
* Fix Corfu completions in terminal for until Emacs 31 is out and stable
#+BEGIN_SRC emacs-lisp
